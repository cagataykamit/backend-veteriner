...
/// <summary>
/// Appointment projection DB + QueryReadModels:AppointmentsEnabled=true factory.
/// </summary>
public sealed class AppointmentQueryReadModelWebApplicationFactory : WebApplicationFactory<global::Program>
{
    public const string CommandConnection = AppointmentProjectionWebApplicationFactory.CommandConnection;
    public const string QueryConnection = AppointmentProjectionWebApplicationFactory.QueryConnection;
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            ...
            .Concat(IntegrationTestAppConfiguration.AppointmentsQueryReadEnabled));
        });
        ...
        builder.ConfigureServices(services =>
        {
            ...
            IntegrationTestDatabaseGuard.EnsureSafeDatabase(
                ...
                allowedPrefix: AppointmentProjectionWebApplicationFactory.QueryDatabaseName);
