...
namespace Backend.Veteriner.Application.LabResults.Commands.Update.Validators;

public sealed class UpdateLabResultCommandValidator : AbstractValidator<UpdateLabResultCommand>
{
