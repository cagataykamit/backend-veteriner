...
namespace Backend.Veteriner.Application.Appointments.Access;

/// <summary>
/// Appointment write handler'larında klinik ataması doğrulaması (IDOR-7A).
/// <see cref="IClinicReadScopeResolver"/> ile read/stock write ile aynı UserClinic semantiği.
/// </summary>
internal static class AppointmentClinicWriteScope
{
