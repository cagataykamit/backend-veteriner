...
// Davet kabul akışı çağıranın mevcut JWT tenant aboneliğinden bağımsız ilerlemelidir
// (read-only/cancelled tenantta oturumlu kullanıcı başka bir tenanta davet kabul edebilmeli).
