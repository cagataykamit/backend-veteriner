...
namespace Backend.Veteriner.Application.Vaccinations.Access;

/// <summary>
/// Vaccination write handler'larında klinik ataması doğrulaması (IDOR-7E).
/// <see cref="IClinicReadScopeResolver"/> ile read/prescription write ile aynı UserClinic semantiği.
/// </summary>
internal static class VaccinationClinicWriteScope
{
