...
namespace Backend.Veteriner.Application.Treatments.Queries.GetList.Validators;

public sealed class GetTreatmentsListQueryValidator : AbstractValidator<GetTreatmentsListQuery>
{
    public GetTreatmentsListQueryValidator()
    {
