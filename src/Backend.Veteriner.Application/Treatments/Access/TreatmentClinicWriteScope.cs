...
namespace Backend.Veteriner.Application.Treatments.Access;

/// <summary>
/// Treatment write handler'larında klinik ataması doğrulaması (IDOR-7C).
/// <see cref="IClinicReadScopeResolver"/> ile read/examination write ile aynı UserClinic semantiği.
/// </summary>
internal static class TreatmentClinicWriteScope
{
