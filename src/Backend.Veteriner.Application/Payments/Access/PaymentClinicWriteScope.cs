...
namespace Backend.Veteriner.Application.Payments.Access;

/// <summary>
/// Payment write handler'larında klinik ataması doğrulaması (IDOR-7H).
/// <see cref="IClinicReadScopeResolver"/> ile read/write ile aynı UserClinic semantiği.
/// </summary>
internal static class PaymentClinicWriteScope
{
