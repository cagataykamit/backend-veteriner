...
internal static class CqrsStartupConfigurationLogger
{
    public static void LogEffectiveConfiguration(WebApplication app)
    {
        ...
        logger.LogInformation(
            "CQRS startup configuration. Environment={Environment} ProjectionEnabled={ProjectionEnabled} AppointmentsQueryReadEnabled={AppointmentsQueryReadEnabled} DashboardQueryReadEnabled={DashboardQueryReadEnabled} CommandDbCatalog={CommandDbCatalog} QueryDbCatalog={QueryDbCatalog}",
