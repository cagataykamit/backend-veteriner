...
namespace Backend.Veteriner.Infrastructure.Migrations
{
    ...
    [Migration("20260702130740_AddPetIdentityFields")]
    partial class AddPetIdentityFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Appointments.Appointment", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "ClinicId", "PetId"), new[] { "ScheduledAtUtc" });

                    b.HasIndex("TenantId", "ClinicId", "ScheduledAtUtc", "Status");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Clinics.ClinicAppointmentSettings", b =>
                {
                    ...
                    b.ToTable("ClinicAppointmentSettings", (string)null);
                });

            modelBuilder.Entity("Backend.Veteriner.Domain.Clinics.ClinicWorkingHour", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "ClinicId", "DayOfWeek")
                        .IsUnique();

                    b.ToTable("ClinicWorkingHours", (string)null);
                });

            modelBuilder.Entity("Backend.Veteriner.Domain.Clinics.UserClinic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.LabResults.LabResult", b =>
                {
                    ...
                    b.Property<DateTime>("ResultDateUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("TenantId", "ResultDateUtc");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Pets.Pet", b =>
                {
                    ...
                    b.Property<string>("PassportOrTagNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("SpecialProtocolNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Prescriptions.Prescription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "PrescribedAtUtc");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Products.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Products.ProductStock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "ClinicId", "ProductId")
                        .IsUnique();

                    b.ToTable("ProductStocks", (string)null);
                });

            modelBuilder.Entity("Backend.Veteriner.Domain.Products.StockMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "ClinicId", "OccurredAtUtc");

                    b.HasIndex("TenantId", "ClinicId", "ProductId", "OccurredAtUtc");

                    b.ToTable("StockMovements", (string)null);
                });

            modelBuilder.Entity("Backend.Veteriner.Domain.Reminders.ReminderDispatchLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Status", "OutboxMessageId", "CreatedAtUtc")
                        .HasDatabaseName("IX_ReminderDispatchLogs_Status_OutboxMessageId_CreatedAtUtc");

                    b.HasIndex("TenantId", "ClinicId", "CreatedAtUtc")
                    ...
                    b.ToTable("ReminderDispatchLogs", (string)null);
                });

            modelBuilder.Entity("Backend.Veteriner.Domain.Reminders.TenantReminderSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("EmailChannelEnabled")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("VaccinationReminderDaysBefore")
                        .HasColumnType("int");

                    b.Property<bool>("VaccinationRemindersEnabled")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("TenantReminderSettings", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Tenants.TenantBillingProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InvoiceBuildingName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("InvoiceBuildingNo")
                        .HasMaxLength(20)
                    ...
                    b.Property<string>("InvoiceDoorNo")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Tenants.TenantInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Tenants.TenantSubscription", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Treatments.Treatment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("TreatmentDateUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("TenantId", "TreatmentDateUtc");
            ...
            modelBuilder.Entity("Backend.Veteriner.Infrastructure.Persistence.Entities.OutboxMessage", b =>
                {
                    ...
                    b.Property<long?>("AppointmentSequence")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CreatedAtUtc", "AppointmentSequence", "Id")
                        .HasDatabaseName("IX_OutboxMessages_AppointmentProjection_PendingClaim")
                        .HasFilter("[ProcessedAtUtc] IS NULL AND [DeadLetterAtUtc] IS NULL AND [AppointmentId] IS NOT NULL AND [AppointmentSequence] IS NOT NULL");
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Clinics.UserClinic", b =>
                {
                    b.HasOne("Backend.Veteriner.Domain.Clinics.Clinic", "Clinic")
                        .WithMany()
                        .HasForeignKey("ClinicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Products.Product", b =>
                {
                    b.HasOne("Backend.Veteriner.Domain.Products.ProductCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Products.ProductStock", b =>
                {
                    ...
                    b.HasOne("Backend.Veteriner.Domain.Products.Product", "Product")
                        .WithMany("Stocks")
            ...
            modelBuilder.Entity("Backend.Veteriner.Domain.Tenants.TenantSubscription", b =>
                {
                    b.HasOne("Backend.Veteriner.Domain.Tenants.Tenant", null)
                        .WithOne()
                        .HasForeignKey("Backend.Veteriner.Domain.Tenants.TenantSubscription", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
