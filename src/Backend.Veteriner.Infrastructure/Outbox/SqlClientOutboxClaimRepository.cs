...
public sealed class SqlClientOutboxClaimRepository : IClientOutboxClaimRepository
{
    private static readonly string[] ClientEventTypes = ClientIntegrationEventTypes.All.ToArray();

    private readonly AppDbContext _dbContext;
    private readonly TimeProvider _timeProvider;

    public SqlClientOutboxClaimRepository(AppDbContext dbContext, TimeProvider timeProvider)
    {
    ...
    private static string BuildClaimSql()
    {
        ...
        for (var i = 0; i < ClientEventTypes.Length; i++)
        {
            if (i > 0)
                typeInClause.Append(", ");
